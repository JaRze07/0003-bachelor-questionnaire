...
> variable still holds the pre-rename repo name and only works because GitHub redirects
> it. **Before resuming work on this project, set up a proper Cloudflare
